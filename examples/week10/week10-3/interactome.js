...
function ticked() {
  ...
  .attrs({
    ...
    "stroke-opacity": d => d.centrality > centrality_range[0] & d.centrality < centrality_range[1] ? 1 : 0.1
  })
}
...
function visualize(data_list) {
  ...
  setup_simulation(graph["nodes"], graph["links"])
  initialize_graph(graph["nodes"], graph["links"])
